...
God.whoami='God';
God.sm=sm;//完善链式操作
God.run=function(func){func.apply(this);return this;};//完善链式操作
God.define=function(func){func.apply(this);return this;};//简化组件定义

God.defaultselector=document;
God.selector=document;
God.alias=function(newname){
    window[newname]=this;
    return this;
};
God.extend=function(newobj){
    $$.merge.apply(this,[newobj]);
    return this;
};

//扩充Jquery-开始
jQuery.fn.extend({sm:sm});//完善与Jquery的链式操作
...
jQuery.fn.extend({safedo:function(f){
        paras=[];
...
jQuery.fn.extend({naming:function(id){
	i=0;
	this.each(function(){
...
jQuery.fn.extend({innertext:function(txt){
        if(!arguments[0]){
            return this.text();
        } else {
...
jQuery.fn.extend({additems:function(type,items){
        if($$.isarray(type)){
            items=type;
            type="append";
        }
...
//页面跳转刷新及标题设置-开始
if(true){
God.reload=function(newurl){
    if(arguments[0]){
        window.location.pathname=$$.checkurl(newurl);
    }else {
        window.location.reload();
    }
    return this;
};
God.open=function(newurl){
    if(arguments[0]){
        window.open(God.maxim.url(newurl));
    }
    return this;
};
God.settitle=function(title){
    this.title=title;
